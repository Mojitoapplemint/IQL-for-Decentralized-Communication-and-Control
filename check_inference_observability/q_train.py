...
q_training_env = gym.make('InferenceEnv-v0', render_mode="human", string_mode="training")

q_1, q_2 = q_training(q_training_env, epochs=10, alpha=0.01, gamma=0.2, epsilon=0.1, print_process=True)
