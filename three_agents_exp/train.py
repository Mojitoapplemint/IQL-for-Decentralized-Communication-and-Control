...
from three_agents_exp_q import S_1, S_3, ACTIONS,A1_OBS, A3_OBS,FOLDER_NAME, get_action, q_training


env = gym.make('ThreeAgentsExpEnv-v0', render_mode=None, string_mode="training")
q_1, q_3 = q_training(env, epochs=1000000, alpha=0.01, gamma=0.9, epsilon=0.1, print_process=True)
