...
class ThreeAgentsEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        self.training_word = self.L_tilde[self.training_word_selection]+"$"
        ...
        curr_event=self.training_word[self.training_word_index]

        info = {'curr_event': curr_event, "string": self.training_word}
    ...
    def render(self):
        print(f"\nEvent '{self.training_word[self.training_word_index]}' occured")
    ...
    def simulate(self):
        ...
        if self.system_state in [4,9,14] and agent_1_disable and agent_2_disable and agent_3_disable:
            print("Failed to enable the event\n")
        
        if self.system_state in [3,8,13] and (agent_1_disable or agent_2_disable or agent_3_disable):
            print("Successfully disabled the event\n")
            
        if self.system_state in [3,8,13] and not (agent_1_disable or agent_2_disable or agent_3_disable):
            print("Failed to disable the event\n")
