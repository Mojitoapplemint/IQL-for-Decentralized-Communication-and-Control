...
def q_main(env, epochs=10000, epsilon=0.1, gamma=0.1, alpha=0.1, print_process=False):
    q_1 =np.zeros(shape=(7, 2))
    q_2 =np.zeros(shape=(7, 2))
    ...
    for epoch in range(epochs):
        ...
        q_1[s_1, communicate_1] += alpha * (reward + gamma * 0 - q_1[s_1, communicate_1])
        q_2[s_2, communicate_2] += alpha * (reward + gamma * 0 - q_2[s_2, communicate_2])
