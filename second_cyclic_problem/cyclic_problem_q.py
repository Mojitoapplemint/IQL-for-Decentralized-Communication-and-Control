...
q_training_env = gym.make('CylicEnv2-v0', render_mode=None, string_mode="training")
...
q_1_df.to_csv(f'second_cyclic_problem/demo_q1_table.csv')
q_2_df.to_csv(f'second_cyclic_problem/demo_q2_table.csv')
